...
public class ArchitectController {
    ...
    @PostMapping("")
    public Architect addArchitect(@RequestBody ArchitectDTO architectDTOFromAPI) {
    ...
    @PatchMapping("/{id}")
    public Architect updateArchitect(@PathVariable int id, @RequestBody ArchitectDTO architectDTOFromAPI) {
