...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 25 mars 2024 à 14:51
...
CREATE TABLE IF NOT EXISTS `building` (
  ...
  KEY `FKnm6dl751nmh3gj9rujb70b73c` (`type_id`)
...
INSERT INTO `building` (`id`, `address`, `description`, `end_build`, `latitude`, `longitude`, `name`, `start_build`, `city_id`, `type_id`) VALUES
...
ALTER TABLE `building`
  ...
  ADD CONSTRAINT `FKnm6dl751nmh3gj9rujb70b73c` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`);
